...
principalComponents_t = pca.fit_transform(images_test)
print(pca.fit_transform(images).shape)
images=principalComponents;
images_test=principalComponents_t;
kernel = 1.0 * RBF(8)


gpc = GaussianProcessClassifier(kernel=kernel,n_restarts_optimizer=3,random_state=None,multi_class="one_vs_rest",max_iter_predict=50,n_jobs=-1)
